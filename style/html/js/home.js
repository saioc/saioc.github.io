        ...
        'Init':function(){
            ...
            $('body').on('click', '.comment_reply', function(e){
                ...
                if($that.attr("data-id")){
                    ...
                    if (str == '<i class="grey icon ion-android-textsms"></i>') {
                        $that.html('<i class="green icon ion-android-textsms"></i>');
                        return false;
                    }
                    if (str == '回复') {
                        $('.comment_reply').html('<i class="green icon ion-android-textsms"></i>');
                    }
                    ...
                    $that.html('<i class="grey icon ion-android-textsms"></i>');
                }
            });
